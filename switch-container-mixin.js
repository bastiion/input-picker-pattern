 ...
 */
export const SwitchContainerMixin = (superClass) => { // eslint-disable-line no-unused-vars
  ...
  return class extends superClass { // eslint-disable-line no-undef
    ...
    _addSwitchListener() {
      ...
      if (switchs) {
        Array.prototype.forEach.call(switchs, s => {
          addListener(s, 'down', this._increm, false);
    ...
    _removeSwitchListener() {
      ...
      if (switchs) {
        Array.prototype.forEach.call(switchs, s => {
          removeListener(s, 'down', this._increm, false);
